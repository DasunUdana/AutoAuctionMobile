...
export class AuctionInventoryPage implements OnInit {
  vehicalList: { id: number, name: string, description: string, price: number, milage: number, img: string, capacity: number }[] = [
    ...
    { "id": 1, "name": "BMW I8", "description": "gggggggggg", "price": 5500000, "milage": 50000, "img": "assets/vehical2.png" , "capacity": 1000 },
    { "id": 2, "name": "Mazda RX8", "description": "hhhhhhhhhhhhhhhhh", "price": 5500000, "milage": 25000, "img": "assets/vehical3.png" , "capacity": 1600 }
  ];
  constructor() { }
